...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedsiria/idk/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/exسوريا200/EX/main/DRAGON.lua')
...
if text == 'سوريا' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV سوريا](t.me/SIRIA199)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '✨ A L E X ✨', url="t.me/SIRIA199"}}, 
} 
...
if text == 'سوريا' or text == 'سوريا' or text == 'سوريا' then
local Text = [[
سوريا لو حابب تتواصل معاه
اتبع الزر إلى تحت ⬇️
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ahmedsiria/idk/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ahmedsiria/idk/main/File_Bot/"..file)
if res == 200 then
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🧚‍♂️](t.me/idek9)') 
return false
end
...
if text == 'تغير امر 🧚‍♂️ اوامر التسليه 🧚‍♂️' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' ✨ الان يمكنك ارسال الكليشه 🧚‍♂️ اوامر التسليه 🧚‍♂️')
...
local Text = [[
بوت حذف حساب ✨
عشان بحب الخيـر وكدا 😂😂 ياريت متفكرش واحذف علي طول 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if (text and text == "تعطيل 🧚‍♂️ اوامر التسليه 🧚‍♂️") then 
send(msg.chat_id_, msg.id_, ' ✨ تم تعطيل 🧚‍♂️ اوامر التسليه 🧚‍♂️')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل 🧚‍♂️ اوامر التسليه 🧚‍♂️") then 
send(msg.chat_id_, msg.id_, '  ✨ تم تفعيل 🧚‍♂️ اوامر التسليه 🧚‍♂️')
